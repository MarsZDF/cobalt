...
use cobol_lexer;
use cobol_migration_analyzer::analysis::{BusinessPriority, CloudPlatform, MigrationStrategy};
use cobol_migration_analyzer::security::safe_write_file;
use cobol_migration_analyzer::{AnalysisConfig, MigrationAnalyzer};
use cobol_parser;
use std::fs;
...
fn generate_text_report(
    assessment: &cobol_migration_analyzer::MigrationAssessment,
) -> Result<String> {
    ...
    let high_risks: Vec<_> = assessment
        .risk_assessment
        .technical_risks
        .iter()
